...
class Trainer:
    ...
    def __init__(
        ...
        self.optimizer = optimizer_class([
            ...
            {"params": self.net.decoder_block1.parameters(), "lr": 0.001},
            {"params": self.net.decoder_block2.parameters(), "lr": 0.001},
            {"params": self.net.decoder_block3.parameters(), "lr": 0.001},
